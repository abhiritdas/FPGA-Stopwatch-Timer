...
HD_PWD='C:/Users/abhir/Documents_Local/UT AUSTIN COURSEWORK/ECE316/FINAL PROJECT/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timeMultiplexingMain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timeMultiplexingMain.tcl
